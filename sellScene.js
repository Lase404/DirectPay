...
const sellScene = new Scenes.WizardScene(
  ...
  async (ctx) => {
    if (!ctx.callbackQuery) return ctx.reply('Please confirm the token.');
...
// Actions (using bot.js handlers where possible)
sellScene.action('confirm_token', (ctx) => ctx.wizard.next());
